    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-header card-header-primary">
                <div class="row">
                    <div class="col-md-10">
                        <h4 class="card-title">Contact Us Requests</h4>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <td class="td-actions text-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ route('udg.show_contact_us_requests', $contact_us_request->id) }}"
                                    ><i class="bx bx-show-alt me-1"></i> View</a
                                    >
                                <form action="{{ route('udg.delete_contact_us_requests', $contact_us_request->id) }}" method="POST">
                                    @csrf
