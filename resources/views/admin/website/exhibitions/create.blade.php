...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <!--begin::Form-->
            <form action="{{ route('udg.store_exhibitions') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 {{ $errors->has('images[]') ? ' has-error' : '' }}">
                            <label class="text-bold-600"> Exhibition Images <span class="text-danger">*</span>
                            </label><br>
