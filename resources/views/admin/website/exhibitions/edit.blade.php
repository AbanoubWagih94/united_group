    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <!--begin::Form-->
                <form action="{{ route('udg.update_exhibitions', $exhibition->id) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6 {{ $errors->has('title_en') ? ' has-error' : '' }} mb-50">
                                ...
                                <input type="text" name="title_en" class="form-control m-input" required="required"
                                    value="{{ $exhibition->title_en }}" placeholder="English Name">
                            ...
                            <div class="col-lg-6 {{ $errors->has('title_ar') ? ' has-error' : '' }} mb-50">
                                ...
                                <input type="text" name="title_ar" class="form-control m-input" required="required"
                                    value="{{ $exhibition->title_ar }}" placeholder="Arabic Name">
                            ...
                            <div class="col-lg-6 {{ $errors->has('description_en') ? ' has-error' : '' }} mb-50">
                                ...
                                <textarea rows="5" name="description_en" id="description_en" class="form-control" required="required" placeholder="English Description">{{ $exhibition->description_en }}</textarea>
                            ...
                            <div class="col-lg-6 {{ $errors->has('description_ar') ? ' has-error' : '' }} mb-50">
                                ...
                                <textarea rows="5" name="description_ar" id="description_ar" class="form-control" required="required" placeholder="Arabic Description">{{ $exhibition->description_ar }}</textarea>
                            ...
                            <div class="col-lg-12 {{ $errors->has('image') ? ' has-error' : '' }} mb-50">
                                ...
                                <input type="file" name="image" id="image" class="form-control m-input">
                                    <div class="mt-2">
                                        <img src="{{ $exhibition->image != '' ? asset('uploads/' . $exhibition->image) :  '' }}" id="image-preview" width="200px" height="200px" />
                                    </div>
                                @if ($errors->has('image'))
                                    <span class="help-block" style="color:red">
                            ...
                            <div class="col-lg-12 {{ $errors->has('images[]') ? ' has-error' : '' }}">
                                <label class="text-bold-600"> Exhibition Images <span class="text-danger">*</span> </label><br>
                                <input type="file" class="form-control" name="images[]" id="images" multiple>
                                <div class="row mt-2" id="result">
                                    @foreach($exhibition->exhibition_images as $exhibition_image)
                                        <div class="col-md-3 mt-2 image-area">
                                            <img src="{{ asset('uploads/' . $exhibition_image->image) }}" width="200px" height="200px" />
                                            <span class="remove-image" data-href="{{ route('udg.remove_exhibition_image', $exhibition_image->id) }}" style="display: inline; cursor: pointer;"><i class="menu-icon tf-icons bx bx-minus-circle" style="margin-right: 0px !important; font-size: 1.20rem !important;"></i></span>
                                        </div>
                                    @endforeach
                                </div>
