    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <!--begin::Form-->
                <form action="{{ route('udg.update_news', $news->id) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6 {{ $errors->has('title_en') ? ' has-error' : '' }} mb-50">
                                ...
                                <input type="text" name="title_en" class="form-control m-input" required="required"
                                    value="{{ $news->title_en }}" placeholder="English Name">
                            ...
                            <div class="col-lg-6 {{ $errors->has('title_ar') ? ' has-error' : '' }} mb-50">
                                ...
                                <input type="text" name="title_ar" class="form-control m-input" required="required"
                                    value="{{ $news->title_ar }}" placeholder="Arabic Name">
                            ...
                            <div class="col-lg-6 {{ $errors->has('description_en') ? ' has-error' : '' }} mb-50">
                                ...
                                <textarea rows="5" name="description_en" id="description_en" class="form-control" required="required" placeholder="English Description">{{ $news->description_en }}</textarea>
                            ...
                            <div class="col-lg-6 {{ $errors->has('description_ar') ? ' has-error' : '' }} mb-50">
                                ...
                                <textarea rows="5" name="description_ar" id="description_ar" class="form-control" required="required" placeholder="Arabic Description">{{ $news->description_ar }}</textarea>
                            ...
                            <div class="col-lg-6 {{ $errors->has('image') ? ' has-error' : '' }} mb-50">
                                ...
                                <input type="file" name="image" id="image" class="form-control m-input">
                                    <div class="mt-2">
                                        <img src="{{ $news->image != '' ? asset('uploads/' . $news->image) :  '' }}" id="image-preview" width="200px" height="200px" />
                                    </div>
                                @if ($errors->has('image'))
                                    <span class="help-block" style="color:red">
