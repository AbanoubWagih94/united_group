...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <!--begin::Form-->
            <form action="{{ route('udg.store_slider') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6 {{ $errors->has('button_en') ? ' has-error' : '' }} mb-50">
                            ...
                            <input type="text" name="button_en" id="button_en" class="form-control m-input" required="required"
                                value="{{ old('button_en') }}" placeholder=" English Button">
                        ...
                        <div class="col-lg-6 {{ $errors->has('button_ar') ? ' has-error' : '' }} mb-50">
                            ...
                            <input type="text" name="button_ar" id="button_ar" class="form-control m-input" required="required"
                                value="{{ old('button_ar') }}" placeholder=" Arabic Button">
