    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <!--begin::Form-->
                <form action="{{ route('udg.update_slider', $homeSlider->id) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6 {{ $errors->has('title_en') ? ' has-error' : '' }} mb-50">
                                ...
                                <input type="text" name="title_en" class="form-control m-input" required="required"
                                    value="{{ $homeSlider->title_en }}" placeholder="English Name">
                            ...
                            <div class="col-lg-6 {{ $errors->has('title_ar') ? ' has-error' : '' }} mb-50">
                                ...
                                <input type="text" name="title_ar" class="form-control m-input" required="required"
                                    value="{{ $homeSlider->title_ar }}" placeholder="Arabic Name">
                            ...
                            <div class="col-lg-6 {{ $errors->has('description_en') ? ' has-error' : '' }} mb-50">
                                ...
                                <textarea rows="5" name="description_en" id="description_en" class="form-control" required="required" placeholder="English Description">{{ $homeSlider->description_en }}</textarea>
                            ...
                            <div class="col-lg-6 {{ $errors->has('description_ar') ? ' has-error' : '' }} mb-50">
                                ...
                                <textarea rows="5" name="description_ar" id="description_ar" class="form-control" required="required" placeholder="Arabic Description">{{ $homeSlider->description_ar }}</textarea>
                            ...
                            <div class="col-lg-6 {{ $errors->has('button_en') ? ' has-error' : '' }} mb-50">
                                ...
                                <input type="text" name="button_en" class="form-control m-input" required="required"
                                    value="{{ $homeSlider->button_en }}" placeholder="English Button">
                            ...
                            <div class="col-lg-6 {{ $errors->has('button_ar') ? ' has-error' : '' }} mb-50">
                                ...
                                <input type="text" name="button_ar" class="form-control m-input" required="required"
                                    value="{{ $homeSlider->button_ar }}" placeholder="Arabic Button">
                            ...
                            <div class="col-lg-6 {{ $errors->has('image') ? ' has-error' : '' }} mb-50">
                                ...
                                <input type="file" name="image" id="image" class="form-control m-input">
                                    <div class="mt-2">
                                        <img src="{{ $homeSlider->image != '' ? asset('uploads/' . $homeSlider->image) :  '' }}" id="image-preview" width="200px" height="200px" />
                                    </div>
                                @if ($errors->has('image'))
                                    <span class="help-block" style="color:red">
